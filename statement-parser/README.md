...
A browser-based tool for bulk parsing ANZ bank statement PDFs and exporting all transaction data as CSV.

## Features

- Drag-and-drop or click to upload multiple PDF statements at once
- Parses ANZ Plus and ANZ Access Advantage statement PDFs
...
1. Open the app
2. Drop one or more ANZ statement PDFs onto the drop zone
